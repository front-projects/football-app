...
const PlayerItem = ({ player }) => {
  ...
  return (
    <>
      ...
      <div
        className={`football-player translate-y-[30px] opacity-0 relative w-full min-h-[80%] h-[80%] bg-white/40 flex flex-col items-center rounded-[14px] mt-10 ${status == "SELECTED" ? "border-[3px] border-[#E7FF2B]" : ""}`}
      >
